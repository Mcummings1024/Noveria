...
app.controller('QuizController', function($scope) {
	...
	self.questions = [{ 'question': "Abortion should be legal in cases of rape, incest, socioeconomic condition, or risk of maternal health.", 'direction': -1, 'axis': 's', 'choice': 0 },
...
app.controller('JoinController', function($scope) {
	...
	$scope.sendMail = function() {
    	var link = "mailto:noverianfederation@gmail.com"
            ...
            + "&body=" + escape($scope.user.name + " (" + $scope.user.email + ") from " 
